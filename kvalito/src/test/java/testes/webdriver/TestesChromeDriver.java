...
public class TestesChromeDriver extends Pagina {
	...
	// Elemento elemento = super.localizarElemento("xpath",
	// "//*[@id=\"todos-find-elements-by\"]");
	...
	//
	// @Test
	// public void navegarParaUmIFrameDepoisVoltarFramePrincipal() throws
	// Exception {
	...
	// int quantidadeRetornada = contarElementos("xpath",
	// "//*[@id=\"todos-find-elements-by\"]/p");
	...
	// int quantidadeRetornada = contarElementos("id",
	// "todos-find-elements-by");
	// assertEquals(quantidadeElementosEsperados, quantidadeRetornada);
	// }
	//
	// @Test
	...
	// int quantidadeElementosEsperados = 1;
	// int quantidadeRetornada = contarElementos("name",
	// "todos-find-elements-by-name");
	// assertEquals(quantidadeElementosEsperados, quantidadeRetornada);
	// }
	//
	// @Test
	...
	// int quantidadeElementosEsperados = 1;
	// int quantidadeRetornada = contarElementos("cssclass",
	// "todos-find-elements-by-class");
	// assertEquals(quantidadeElementosEsperados, quantidadeRetornada);
	// }
	//
	// @Test
	...
	// int quantidadeElementosEsperados = 1;
	// int quantidadeRetornada = contarElementos("cssselector",
	// "#todos-find-elements-by-cssselector");
	// assertEquals(quantidadeElementosEsperados, quantidadeRetornada);
	// }
	//
	// @Test
	// public void exibiuElementoPorXpath() throws Exception {
	// boolean exibiu = existeElemento("xpath",
	// "//*[@id=\"todos-find-elements-by\"]/p[5]");
	// assertTrue(exibiu);
	// }
	//
	// @Test
	...
	// Elemento buttonLigaDiv =
	// localizarElemento("esperar-visibilidade-button");
	// Elemento divQueSeraExibido =
	// localizarElemento("esperar-visibilidade-div-que-aparecera");
	//
	...
	// Elemento buttonDesligaDiv =
	// localizarElemento("esperar-invisibilidade-button");
	// Elemento divQueSeraOcultado =
	// localizarElemento("esperar-invisibilidade-div-que-desaparecera");
	//
	...
	// Elemento buttonLigaDiv =
	// localizarElemento("esperar-visibilidade-div-dinamico-button");
	//
	// buttonLigaDiv.clicar();
	...
	// Elemento elemento =
	// localizarElemento("arrastar-elemento-origem-para-destino");
	...
	//
	// @Test
	// public void clicarLinkComJavascriptNoHrefSemScroolDePagina() throws
	// Exception {
	...
	//
	// @Test
	// public void clicarLinkComJavascriptNoHrefComScroolDePagina() throws
	// Exception {
	// abrirUrl(urlPagina + "/PaginaNecessitaScrool.html");
	...
	// String textoElemento = localizarElemento("name",
	// "todos-find-elements-by-name").getConteudo();
	// assertEquals(resultadoEsperado, textoElemento);
	// }
	//
	// @Test
	...
	// String textoElemento = localizarElemento("id",
	// "todos-find-elements-by-id").getConteudo();
	// assertEquals(resultadoEsperado, textoElemento);
	// }
	//
	// @Test
	...
	// String textoElemento = localizarElemento("cssclass",
	// "todos-find-elements-by-class").getConteudo();
	// assertEquals(resultadoEsperado, textoElemento);
	// }
	//
	// @Test
	...
	// String textoElemento = localizarElemento("cssselector",
	// "#todos-find-elements-by-cssselector").getConteudo();
	// assertEquals(resultadoEsperado, textoElemento);
	// }
	//
	// @Test
	// public void executarMouseOver() throws Exception {
	// Elemento divPassarMousePorCima =
	// localizarElemento("mouse-over-passe-mouse");
	// Elemento divQueSeraExibido =
	// localizarElemento("mouse-over-ira-aparecer");
	//
	// assertFalse(divQueSeraExibido.estaVisivel());
	...
	//
	// @Test
	// public void naoGerarErroEmUmaSituacaoQueLancaStaleException() throws
	// Exception {
