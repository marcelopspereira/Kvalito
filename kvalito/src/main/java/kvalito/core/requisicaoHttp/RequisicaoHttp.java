...
public class RequisicaoHttp {
	...
	public void executar() throws IOException {
		...
		while (true) {
			...
			this.redirecionamentos.add(new EnderecoHttp(url, connection.getResponseCode(), cookieStore.getCookies(), body, connection.getHeaderFields()));
	...
	/**
	 * Extrai informações do conteudo da requisição de acordo com Expressão
	 * Regular
	 * 
	...
	/**
	 * Em caso de redirecionamento, retorna a lista dos endereços envolvidos na
	 * Requisição Http
	 */
	...
	/**
	 * Adiciona um unico parametro para serem enviado no corpo da Requisicao
	 * pelo metodo POST
	 * 
	 * @param valor
	 *            valor do parametro
